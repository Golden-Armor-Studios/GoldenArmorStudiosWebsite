<template>
	<div class="repo-wrapper">
		...
		<h1 class="homepage-title">BattleDawnPro Project Status</h1>
		<p class="homepage-p description">
			Live data pulled from the GitHub repository to help the team track progress and upcoming work.
		</p>
			...
			<div class="status-row">
				<div class="status-card card-standard">
					...
					<a
						...
						href="https://github.com/Golden-Armor-Studios/BattleDawnPro"
						target="_blank"
	...
	const fetchRepoData = async () => {
		...
		try {
			const [repoResponse, issuesResponse, milestonesResponse] = await Promise.all([
				fetch('https://api.github.com/repos/Golden-Armor-Studios/BattleDawnPro'),
				fetch('https://api.github.com/repos/Golden-Armor-Studios/BattleDawnPro/issues?state=open'),
				fetch('https://api.github.com/repos/Golden-Armor-Studios/BattleDawnPro/milestones?state=all&sort=due_on')
			])
